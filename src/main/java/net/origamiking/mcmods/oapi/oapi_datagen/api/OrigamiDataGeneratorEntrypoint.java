 ...
 *
 * <p>In {@code fabric.mod.json}, the entrypoint is defined with {@code origami-datagen} key.</p>
 *
 * @see OrigamiDataGenerator
 */
@FunctionalInterface
public interface OrigamiDataGeneratorEntrypoint {
    void onInitializeOrigamiDataGenerator(OrigamiDataGenerator origamiDataGenerator);
