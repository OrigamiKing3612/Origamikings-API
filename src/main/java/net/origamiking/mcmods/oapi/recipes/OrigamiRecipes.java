...
public class OrigamiRecipes {
    protected static ShapelessRecipeJsonBuilder createButtonRecipe(ItemConvertible output, Ingredient input) {
    ...
    protected static ShapelessRecipeJsonBuilder createWaxable(ItemConvertible output, Ingredient input) {
    ...
    protected static ShapelessRecipeJsonBuilder createUncompress(ItemConvertible output, Ingredient input, int count) {
    ...
    protected static CraftingRecipeJsonBuilder createHelmet(ItemConvertible output, Ingredient input) {
        return ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, output, 1).input('I', input).pattern("III").pattern("I I");
    }

    protected static CraftingRecipeJsonBuilder createChestplate(ItemConvertible output, Ingredient input) {
        return ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, output, 1).input('I', input).pattern("I I").pattern("III").pattern("III");
    }

    protected static CraftingRecipeJsonBuilder createLeggings(ItemConvertible output, Ingredient input) {
        return ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, output, 1).input('I', input).pattern("III").pattern("I I").pattern("I I");
    }

    protected static CraftingRecipeJsonBuilder createBoots(ItemConvertible output, Ingredient input) {
        return ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, output, 1).input('I', input).pattern("I I");
    }
