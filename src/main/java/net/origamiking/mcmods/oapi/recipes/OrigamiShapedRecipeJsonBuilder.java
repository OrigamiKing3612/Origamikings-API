...
public class OrigamiShapedRecipeJsonBuilder extends RecipeJsonBuilder implements CraftingRecipeJsonBuilder {
    ...
    @Override
    public OrigamiShapedRecipeJsonBuilder criterion(String string, CriterionConditions criterionConditions) {
    ...
    public void offerTo(Consumer<RecipeJsonProvider> exporter, Identifier recipeId) {
        ...
        exporter.accept(new OrigamiShapedRecipeJsonBuilder.OrigamiShapedRecipeJsonProvider(recipeId, this.output, this.count, this.group == null ? "" : this.group, ShapedRecipeJsonBuilder.getCraftingCategory(this.category), this.pattern, this.inputs, this.advancementBuilder, recipeId.withPrefixedPath("recipes/" + this.category.getName() + "/"), this.showNotification));
    }
